        ...
        <div class="container" style="margin-top: 10px;">
            <div class="row" style="border: 1px darkgrey solid; border-radius: 10px;width: 50%; margin: 0 auto; padding: 20px;" >
				...
				<form:select path="category" class="form-control" >
					<form:option value="7">Iphone</form:option>
					<form:option value="8">SamSung</form:option>
					<form:option value="9">Xaomi</form:option>
					<form:option value="13">Nokia</form:option>
				</form:select>
                        <div class="form-group">
                            <label>Image</label>
                        ...
                        <a href="/admin/users/views" class="btn btn-primary">Display Product</a>
                    </form:form>
                </div>
            </div>
        </div>
